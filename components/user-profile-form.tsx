...
export default function UserProfileUpdateForm({ user }: { user: Tables<'users'> }) {
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Basic information about you.</p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Details about your studies.</p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Other details that help us match you better.</p>
            </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g. Programming, Music, Sports" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div className="bg-muted p-4 rounded-md">
              <p className="text-sm text-muted-foreground">
                Disclaimer: The information provided in this form is optional but will help our system to better match you with mentors or mentees, depending on your role. Your privacy is important to us, and this information will be used solely for the purpose of improving your experience on our platform.
              </p>
            </div>
